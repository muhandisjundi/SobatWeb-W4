...
const Hero = () => {
  ...
  return (
    <section 
      ...
      id="home" 
      /* Ditambahkan pt-32 untuk mobile agar tidak tertutup Navbar, dan md:pt-0 untuk desktop */
      className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-slate-50 pt-32 md:pt-0"
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-20 pb-12">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/60 backdrop-blur-md border border-white/50 shadow-sm mb-6 md:mb-10"
        >
        ...
        {/* Heading - Ukuran teks dikecilkan sedikit di mobile (text-4xl) agar lebih proporsional */}
        <motion.h1 
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="text-4xl md:text-7xl lg:text-[6.5rem] font-serif text-slate-800 leading-[1.2] md:leading-[1.1] mb-6 md:mb-8 tracking-tight drop-shadow-sm"
        >
          Healing <span className="italic text-teal-600 relative inline-block">
             ...
             <motion.span 
               ...
               className="absolute bottom-1 md:bottom-2 left-0 h-[4px] md:h-[6px] bg-teal-200/50 -z-10 rounded-full"
             />
          </span>.<br />
          Growing <span className="italic text-pink-500 relative inline-block">
            ...
            <motion.span 
               ...
               className="absolute bottom-1 md:bottom-2 left-0 h-[4px] md:h-[6px] bg-pink-200/50 -z-10 rounded-full"
             />
          </span>.
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-slate-600 text-base md:text-xl max-w-2xl mx-auto mb-10 md:mb-12 font-medium leading-relaxed tracking-wide"
        >
        ...
        >
          <a href="#contact" className="w-full sm:w-auto group px-8 md:px-10 py-4 md:py-5 bg-gradient-to-r from-teal-500 to-teal-400 text-white rounded-full font-bold shadow-lg hover:-translate-y-1 transition-all flex items-center justify-center gap-3">
            Gabung Komunitas <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
          </a>
          
          <a href="#about" className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-white/80 backdrop-blur-sm text-slate-600 rounded-full font-bold border border-white hover:border-teal-200 hover:text-teal-600 transition-all flex items-center justify-center gap-2 shadow-sm">
